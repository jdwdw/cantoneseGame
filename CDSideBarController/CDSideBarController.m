...
-(void)changetheimage
{
    ...
    if (musicOn) {
        [_buttonList[2] setImage:[UIImage imageNamed:@"musicOnButtonImage.png"] forState:UIControlStateNormal];
        NSLog(@"musicOn");
    }else{
        [_buttonList[2] setImage:[UIImage imageNamed:@"musicOffButtonImage.png"] forState:UIControlStateNormal];
        NSLog(@"musicOff");
    }
